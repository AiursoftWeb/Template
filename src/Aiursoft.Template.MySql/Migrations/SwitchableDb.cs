        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ChineseName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoneyMaps", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comments = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TeacherId = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeachEvents", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoneyMaps_ClassTypeId",
                table: "MoneyMaps",
                column: "ClassTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_MoneyMaps_LevelId",
                table: "MoneyMaps",
                column: "LevelId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachEvents_ClassTypeId",
                table: "TeachEvents",
                column: "ClassTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachEvents_SiteId",
                table: "TeachEvents",
                column: "SiteId");

            migrationBuilder.CreateIndex(
                name: "IX_TeachEvents_TeacherId",
                table: "TeachEvents",
                column: "TeacherId");
        }
